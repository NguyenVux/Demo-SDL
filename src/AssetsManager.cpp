...
AssetsManager::AssetsManager(SDL_Renderer *renderer) : m_renderer(renderer) {
...
bool AssetsManager::IsInitialized() const { return m_renderer != nullptr; }

size_t AssetsManager::GetTextureCount() const { return m_textures.size(); }

bool AssetsManager::CreateSprite(const std::string &name, SDL_Texture *texture,
                                 const SDL_Rect &rect) {
  if (HasSprite(name)) {
    return false;
  }
...
bool AssetsManager::CreateSprite(const std::string &name,
...
bool AssetsManager::CreateSpriteSheet(
    const std::string &name, const std::vector<std::string> &spriteNames) {
...
const SpriteSheet *
AssetsManager::GetSpriteSheet(const std::string &name) const {
...
bool AssetsManager::IsValidRenderer() const { return m_renderer != nullptr; }

bool AssetsManager::CreateAnimation(const std::string &name,
                                    const std::string &spriteSheetName, int fps,
                                    bool loop) {
