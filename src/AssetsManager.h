...
public:
  ...
  // Sprite management
  bool CreateSprite(const std::string &name, SDL_Texture *texture,
                    const SDL_Rect &rect);
  bool CreateSprite(const std::string &name, const std::string &texture,
                    const SDL_Rect &rect);
  const Sprite *GetSprite(const std::string &name) const;
  bool HasSprite(const std::string &name) const;

  // SpriteSheet management
  bool CreateSpriteSheet(const std::string &name,
  ...
  bool CreateAnimation(const std::string &name,
                       const std::string &spriteSheetName, int fps, bool loop);
